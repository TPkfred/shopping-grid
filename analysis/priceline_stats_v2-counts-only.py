"""
Version 2: "counts" only - of searches, solutions, and markets
Do not compute distributions
"""
import argparse
import datetime
import random
...
BASE_OUTPUT_DIR = "s3://tvlp-ds-users/kendra-frederick/tmp/priceline-eda2/"
...
def load_analyze_data(spark, date, test):
    ...
    m_pl = pl_markets.count()
    print("Number of Priceline markets: ", m_pl)

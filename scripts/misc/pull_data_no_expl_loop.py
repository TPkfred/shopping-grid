"""
For data source = midt_1_5 in data center
"""
...
BASE_INPUT_DIR = "/data/estreaming/midt_1_5_pn/"
BASE_OUTPUT_DIR = "/user/kendra.frederick/tmp/"
...
if __name__ == "__main__":
    ...
    for hour in hours:
        ...
        print("Reading data for hour {}".format(hour))
        ...
        df_filt.coalesce(1).write.mode("append").parquet(output_path)
        loop_end = datetime.datetime.now()
        loop_elapsed_time = (loop_end - loop_start).total_seconds() / 60
        print("Done! Loop elasped time: {:.2f}".format(loop_elapsed_time))
